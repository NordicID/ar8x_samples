...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Logging_t, stringdata) + ofs \
...
void Logging::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->toLogging((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Logging::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Logging::toLogging)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Logging::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Logging.data,
      qt_meta_data_Logging,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Logging.stringdata))
...
// SIGNAL 0
void Logging::toLogging(QString _t1)
{
